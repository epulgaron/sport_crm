...
class Errors_soapController extends SecureController
{
    ...
    public function behaviors()
    {
        ...
        $array['authenticator']['except'] = ['errors_data'];
        return $array;
    }
    /**
     * {@inheritdoc}
    ...
    public function actions()
    {
        return [
            'errors_data' => [
                ...
                'classMap' => ['Errors' => 'api\modules\entities\models\Errors'],
                'serviceOptions' => [
    ...
    /**
     * Simple test which returns a List of errors in order to see how the wsdl pans out
     * @param [] $params
     * @return object[]
     * @soap
     */
    ...
    public function errors_list()
    {
        ...
        return $this->encode_result(Errors::list_model($params));
    }

    /**
     * Simple test which returns a data of errors  with id in order to see how the wsdl pans out
     * @param int $id
     * @return api\modules\entities\models\Errors
     * @soap
     */
    public function errors_view($id)
    {
        $params=[];
        if (func_get_args())
            $params = func_get_args()[0]['params'];
        return $this->encode_result(Errors::view($id, $params));
    }
}
