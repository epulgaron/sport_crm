...
use api\modules\managment\services\Session_level_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Session_level_list;
use yii\web\ServerErrorHttpException;

class Session_level_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Session_level_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Session_level_listService();
        return $this->service;
    }
