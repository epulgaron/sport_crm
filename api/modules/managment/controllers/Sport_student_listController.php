...
use api\modules\managment\services\Sport_student_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Sport_student_list;
use yii\web\ServerErrorHttpException;

class Sport_student_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Sport_student_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Sport_student_listService();
        return $this->service;
    }
