...
use api\modules\managment\services\Test_level_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Test_level_list;
use yii\web\ServerErrorHttpException;

class Test_level_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Test_level_listService();
        return $this->service;
    }
