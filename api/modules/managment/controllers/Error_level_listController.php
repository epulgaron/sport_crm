...
use api\modules\managment\services\Error_level_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Error_level_list;
use yii\web\ServerErrorHttpException;

class Error_level_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Error_level_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Error_level_listService();
        return $this->service;
    }
