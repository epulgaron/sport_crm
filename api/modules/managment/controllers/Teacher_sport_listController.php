...
use api\modules\managment\services\Teacher_sport_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Teacher_sport_list;
use yii\web\ServerErrorHttpException;

class Teacher_sport_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Teacher_sport_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Teacher_sport_listService();
        return $this->service;
    }
