...
use api\modules\managment\services\Content_level_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Content_level_list;
use yii\web\ServerErrorHttpException;

class Content_level_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Content_level_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Content_level_listService();
        return $this->service;
    }
