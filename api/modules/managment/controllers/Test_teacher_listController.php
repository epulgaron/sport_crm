...
use api\modules\managment\services\Test_teacher_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Test_teacher_list;
use yii\web\ServerErrorHttpException;

class Test_teacher_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Test_teacher_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Test_teacher_listService();
        return $this->service;
    }
