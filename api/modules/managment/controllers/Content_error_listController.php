...
use api\modules\managment\services\Content_error_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Content_error_list;
use yii\web\ServerErrorHttpException;

class Content_error_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Content_error_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Content_error_listService();
        return $this->service;
    }
