...
use api\modules\managment\services\Test_session_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Test_session_list;
use yii\web\ServerErrorHttpException;

class Test_session_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Test_session_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Test_session_listService();
        return $this->service;
    }
