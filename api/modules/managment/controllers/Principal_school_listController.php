...
use api\modules\managment\services\Principal_school_listService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\managment\models\Principal_school_list;
use yii\web\ServerErrorHttpException;

class Principal_school_listController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\managment\models\Principal_school_list';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Principal_school_listService();
        return $this->service;
    }
