 ...
 * @property string $country_acr
 * @property string $country_name

 * Los siguientes son las relaciones de este modelo :

 * @property Schools[] $arrayschools
 */
...
class Countries extends RestModel 
{
    ...
    {
        return [
			[['country_name'],'required','on'=>['create','default']],
			[['id_country'],'required', 'on' => 'update'],
			[['id_country'],'integer'],
			[['country_acr'], 'string', 'max'=>10],
     ...
     */
	  public function getArrayschools()
		{
			return $this->hasMany(Schools::class, ['country_id' => 'id_country']);
		}
 /**
    ...
    static function select_2_list($parameters = [])
    {
        ...
        $select = ['*', 'countries.id_country as id', 'countries.country_acr as text'];
        $result = new \stdClass();
        $result->data = [];
        ...
        $result->data=$result->data->andWhere('countries.country_acr LIKE '."'%".$like."%'")->asArray()->all();
        return $result;
