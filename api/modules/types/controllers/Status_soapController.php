...
class Status_soapController extends SecureController
{
    ...
    public function behaviors()
    {
        ...
        $array['authenticator']['except'] = ['status_data'];
        return $array;
    }
    /**
     * {@inheritdoc}
    ...
    public function actions()
    {
        return [
            'status_data' => [
                ...
                'classMap' => ['Status' => 'api\modules\types\models\Status'],
                'serviceOptions' => [
    ...
    /**
     * Simple test which returns a List of status in order to see how the wsdl pans out
     * @param [] $params
     * @return object[]
     * @soap
     */
    ...
    public function status_list()
    {
        ...
        return $this->encode_result(Status::list_model($params));
    }

    /**
     * Simple test which returns a data of status  with id in order to see how the wsdl pans out
     * @param int $id
     * @return api\modules\types\models\Status
     * @soap
     */
    public function status_view($id)
    {
        ...
        if (func_get_args())
            $params = func_get_args()[0]['params'];
        return $this->encode_result(Status::view($id, $params));
    }
}
