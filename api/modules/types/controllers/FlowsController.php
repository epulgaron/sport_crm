...
use api\modules\types\services\FlowsService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\types\models\Flows;
use yii\web\ServerErrorHttpException;

class FlowsController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\types\models\Flows';
